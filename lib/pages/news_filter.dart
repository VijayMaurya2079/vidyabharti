...
import 'package:vidyabharti/pages/news_filter_list.dart';
...
class NewsFilterPage extends StatefulWidget {
  @override
  _NewsFilterPageState createState() => _NewsFilterPageState();
}
  ...
  getNewsList() async {
    try {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => NewsFilterListPage(_user),
        ),
      );
      // } else {
      //   Navigator.of(context).push(
      //     MaterialPageRoute(
      //       builder: (context) => NewsFilterListPage(),
      //     ),
      //   );
      // }
    } catch (e) {
