...
class VideoActivityCounts extends StatefulWidget {
  final String id;

  VideoActivityCounts({Key key, this.id}) : super(key: key);

  _VideoActivityCountsState createState() => _VideoActivityCountsState();
}

class _VideoActivityCountsState extends State<VideoActivityCounts> {
  @override
  void initState() {
    super.initState();
